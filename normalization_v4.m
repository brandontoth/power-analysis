...
if max_frq == 20
    control.nrem_auc = vertcat(control.nrem_delta,control.nrem_theta,control.nrem_alpha);
    control.wake_auc = vertcat(control.wake_delta,control.wake_theta,control.wake_alpha);
    control.rem_auc = vertcat(control.rem_delta,control.rem_theta,control.rem_alpha);
    exp.nrem_auc = vertcat(exp.nrem_delta,exp.nrem_theta,exp.nrem_alpha);
    exp.wake_auc = vertcat(exp.wake_delta,exp.wake_theta,exp.wake_alpha);
    exp.rem_auc = vertcat(exp.rem_delta,exp.rem_theta,exp.rem_alpha);
else
    control.nrem_auc = vertcat(control.nrem_delta,control.nrem_theta,control.nrem_alpha,control.nrem_beta,control.nrem_gamma);
    control.wake_auc = vertcat(control.wake_delta,control.wake_theta,control.wake_alpha,control.wake_beta,control.wake_gamma);
    control.rem_auc = vertcat(control.rem_delta,control.rem_theta,control.rem_alpha,control.rem_beta,control.rem_gamma);
    exp.nrem_auc = vertcat(exp.nrem_delta,exp.nrem_theta,exp.nrem_alpha,exp.nrem_beta,exp.nrem_gamma);
    exp.wake_auc = vertcat(exp.wake_delta,exp.wake_theta,exp.wake_alpha,exp.wake_beta,exp.wake_gamma);
    exp.rem_auc = vertcat(exp.rem_delta,exp.rem_theta,exp.rem_alpha,exp.rem_beta,exp.rem_gamma);
end
...
subplot(3,2,2)
if max_frq == 20
    wake_bar = [mean(control.wake_delta),mean(exp.wake_delta);mean(control.wake_theta),mean(exp.wake_theta);mean(control.wake_alpha),mean(exp.wake_alpha)];
else
...
subplot(3,2,4)
if max_frq == 20
    nrem_bar = [mean(control.nrem_delta),mean(exp.nrem_delta);mean(control.nrem_theta),mean(exp.nrem_theta);mean(control.nrem_alpha),mean(exp.nrem_alpha)];
else
...
subplot(3,2,6)
if max_frq == 20
    rem_bar = [mean(control.rem_delta),mean(exp.rem_delta);mean(control.rem_theta),mean(exp.rem_theta);mean(control.rem_alpha),mean(exp.rem_alpha)];
else
